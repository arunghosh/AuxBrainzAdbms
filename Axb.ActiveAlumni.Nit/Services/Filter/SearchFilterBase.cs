...
namespace Axb.ActiveAlumni.Nit.Services
{
    public abstract class SearchFilterBase<T, V>: FilterBase
    {
        ...
        public abstract void ComposeFilters(IEnumerable<T> users);
        public abstract IEnumerable<T> Execute(IEnumerable<T> users);
    ...
    public abstract class FilterBase
    {
        ...
        protected void ComposeFilterItems(IEnumerable<string> masterList)
        {
            ...
            var orderedList = grpdItems.OrderByDescending(cn => cn.Count);
